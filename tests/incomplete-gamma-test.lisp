...
(test incomplete-gamma-small-p
  :description "Test upper incomplete gamma, P, with small data"
...
(test incomplete-gamma-small-q
  :description "Test lower incomplete gamma, Q, with small data"
  (let ((result (test-fn (select incomplete-gamma-small-data t 3)
			 #'(lambda (i params)
			     (specfun:q-incomplete-gamma (aref (first params) i) (aref (second params) i)))
			 (select incomplete-gamma-small-data t 0) (select incomplete-gamma-small-data t 1))))
...
(test incomplete-gamma-medium-p
  :description "Test upper incomplete gamma, P, with medium data"
...
(test incomplete-gamma-medium-q
  :description "Test lower incomplete gamma, Q, with medium data"
...
(test incomplete-gamma-large-p
  :description "Test upper incomplete gamma, P, with large data"
...
(test incomplete-gamma-large-q
  :description "Test lower incomplete gamma, Q, with large data"
...
(test incomplete-gamma-integer-p
  :description "Test upper incomplete gamma, P, with integer data"
...
(test incomplete-gamma-integer-q
  :description "Test lower incomplete gamma, Q, with integer data"
